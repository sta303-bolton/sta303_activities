...
This is a revision task based on the Week 3 Team Up! activity. There are no bonus points for completing the task asynchronously, but I hope it might be a useful revision tool for you.
...
question("What is the correct answer?",
         ...
         answer("C"),
         answer("D"),
         message = "'Crawl delay: 10 sec' tells us that we should limit the rate at which we scrape. 'The path is scrapable for this user-agent' means there is nothing in the robots.txt that says we can't scrape this page (but there might be in the T&Cs)."
)
```
...
question("What is the correct answer?",
         ...
         message = "We should consider all of these things."
)
```
...
question("What is the correct answer?",
         ...
         answer("C"),
         answer("D"),
         message = "The purpose of random assignment is to hopefully have the groups be as similar as possible across potential confounders so we can make causal claims."
)
```
...
question("What is the correct answer?",
         ...
         answer("C"),
         answer("D", correct = TRUE),
         message = "Participants are recruited based on their outcome status (sleep quality) which makes this a case-control study."
)
```
...
question("What is the correct answer?",
         ...
         answer("C"),
         answer("D"),
         message = "Students are recruited based on exposure status (degree), not assigned by researchers (i.e., not an RCT), and the outcome will be observed in the future, so this is a prospective cohort study."
)
```