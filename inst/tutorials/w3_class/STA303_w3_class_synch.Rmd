...
setwd("/Users/lizabolton/Dropbox/U of T/STA 303/Weekly materials/Week 3/W3_class")
...
Suppose when enrolling in STA303 you were randomly assigned to either a mandatory synchronous class or an asynchronous pre-recorded class and then final grades were compared between the two groups. Which ONE of the following is TRUE?
